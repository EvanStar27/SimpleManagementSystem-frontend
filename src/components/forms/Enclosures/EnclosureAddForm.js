...
import { useAddNewEnclosure } from "../../../hooks/EnclosureHooks";

const EnclosureAddForm = ({ isOpen, onClose, title }) => {
  ...
  const onSuccess = (data) => {
    ...
    toast({
      ...
      variant: "left-accent",
      title: "Success",
      description: "Enclosure Added Successfully",
      status: "success",
      duration: 5000,
      isClosable: true,
    });
  ...
  // Queries
  const enclosureQuery = useAddNewEnclosure(onSuccess);
...
export default EnclosureAddForm;
