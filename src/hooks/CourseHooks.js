...
// PUT Enroll
const updateEnrolledCourse = (details) => {
  return request({
    url: `/courses/enroll/${details.csMappingId}`,
    method: "put",
    data: details,
  });
};

export const useUpdateEnrolledCourse = (onSuccess) => {
  return useMutation(updateEnrolledCourse, {
    onSuccess,
    onError: (error) => {
      return error;
    },
